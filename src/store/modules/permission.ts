...
import router, { constantRoutes, dynamicRoutes } from 'Routes/index'
import { store } from 'Store/index'
import { $getRouters } from 'API/user'
import Layout from '@/layout/index.vue'
import ParentView from 'Comments/ParentView/index.vue'
...
export const usePermissionStore = defineStore('permission', () => {
   ...
   * @param _lastRouter 上一级路由
   * @param type 是否是重写路由
   */
  const filterAsyncRouter = (asyncRouterMap: RouteOption[], _lastRouter?: RouteOption, type = false): RouteOption[] => {
